...
export Buffer, store!, get_batch, update_wv!, reset_wv!
...
function store!(buffer, s, a, r, s′, t; w=1.0)
    ...
    buffer.a[:, buffer.idx] .= onehot(a, 1:size(buffer.a, 1))
